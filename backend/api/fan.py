...
def get_fan_dashboard(fan_id):
    return jsonify({
        ...
        "advisories": ["Gate 2 experiencing heavy congestion. Rerouting via Gate 4 recommended."],
...
def get_fan_journey():
    ...
    steps = [
        {"step_name": "ARRIVAL", "mapped_intelligence_module": "Transport Intelligence",
         "description": "AI traffic guidance & transit arrival synchronization.", "status": "COMPLETED", "progress_pct": 100, "est_completion": "Arrived"},
        {"step_name": "PARKING", "mapped_intelligence_module": "Transport Intelligence",
         "description": "Smart parking lot occupancy & ADA reserved space allocation.", "status": "COMPLETED", "progress_pct": 100, "est_completion": "Parked in Lot B"},
        {"step_name": "SECURITY", "mapped_intelligence_module": "Operations Intelligence",
         "description": "Contactless security screening & AI bag-check flow.", "status": "COMPLETED", "progress_pct": 100, "est_completion": "Cleared (< 1 min)"},
        {"step_name": "ENTRY", "mapped_intelligence_module": "Crowd Intelligence",
         "description": "Express turnstile gate entry optimization.", "status": "COMPLETED", "progress_pct": 100, "est_completion": "Gate 4 Express"},
        {"step_name": "SEAT", "mapped_intelligence_module": "Crowd Intelligence",
         "description": "AR wayfinding & step-free concourse seat navigation.", "status": "ACTIVE", "progress_pct": 100, "est_completion": "Section 114"},
        {"step_name": "FOOD", "mapped_intelligence_module": "Operations Intelligence",
         "description": "Real-time concession queue telemetry & mobile ordering.", "status": "ACTIVE", "progress_pct": 65, "est_completion": "< 3 min wait"},
        {"step_name": "RESTROOM", "mapped_intelligence_module": "Volunteer & Accessibility Intelligence",
         "description": "ADA-compliant restroom locator with queue avoidance.", "status": "ACTIVE", "progress_pct": 80, "est_completion": "0 min queue"},
        {"step_name": "SHOPPING", "mapped_intelligence_module": "Operations Intelligence",
         "description": "Official megastore queue status & express pickup.", "status": "READY", "progress_pct": 0, "est_completion": "Open until 23:00"},
        {"step_name": "ENTERTAINMENT", "mapped_intelligence_module": "Fan Experience Portal",
         "description": "Synchronized halftime show & interactive fan zones.", "status": "READY", "progress_pct": 0, "est_completion": "Live at Halftime"},
        {"step_name": "MATCH", "mapped_intelligence_module": "Fan Experience Portal",
         "description": "Live tournament match concierge & real-time analytics.", "status": "LIVE", "progress_pct": 74, "est_completion": "74' Played"},
        {"step_name": "EXIT", "mapped_intelligence_module": "Emergency & Crowd Intelligence",
         "description": "Predictive crowd egress & safe evacuation wayfinding.", "status": "PREDICTIVE", "progress_pct": 0, "est_completion": "< 6 min Egress"},
        {"step_name": "TRANSPORT_HOME", "mapped_intelligence_module": "Transport Intelligence",
         "description": "EV shuttle tracking & post-match parking egress.", "status": "PREDICTIVE", "progress_pct": 0, "est_completion": "Shuttles Every 4 min"},
    ]
...
def get_pois():
    ...
    for idx, z in enumerate(zones):
        pois.append({
            ...
            "category": "INFO" if "Gate" in z.name else ("MEDICAL" if "Medical" in z.name else "FOOD"),
            "zone_id": z.id or 1,
    ...
    pois.extend([
        {"id": 101, "name": "Level 1 First Aid Station (ADA Certified)", "category": "MEDICAL", "zone_id": 2, "accessibility_equipped": True, "distance_m": 110, "walking_time_mins": 2, "crowd_level_pct": 12, "status": "OPEN"},
        {"id": 102, "name": "Concourse North Gourmet Concession", "category": "FOOD", "zone_id": 1, "accessibility_equipped": True, "distance_m": 180, "walking_time_mins": 3, "crowd_level_pct": 35, "status": "OPEN"},
        {"id": 103, "name": "Family & ADA Restroom Block C", "category": "RESTROOM", "zone_id": 3, "accessibility_equipped": True, "distance_m": 90, "walking_time_mins": 1, "crowd_level_pct": 10, "status": "OPEN"},
        {"id": 104, "name": "Express EV Shuttle Hub", "category": "TRANSPORT", "zone_id": 4, "accessibility_equipped": True, "distance_m": 320, "walking_time_mins": 5, "crowd_level_pct": 45, "status": "OPEN"},
        {"id": 105, "name": "Official Megastore & Memorabilia", "category": "MERCH", "zone_id": 5, "accessibility_equipped": True, "distance_m": 250, "walking_time_mins": 4, "crowd_level_pct": 60, "status": "OPEN"},
        {"id": 106, "name": "Fast-Charge Mobile Power Plaza", "category": "CHARGING", "zone_id": 1, "accessibility_equipped": True, "distance_m": 140, "walking_time_mins": 2, "crowd_level_pct": 25, "status": "OPEN"},
        {"id": 107, "name": "24/7 Multi-Bank ATM Lobby", "category": "ATM", "zone_id": 2, "accessibility_equipped": True, "distance_m": 130, "walking_time_mins": 2, "crowd_level_pct": 15, "status": "OPEN"},
        {"id": 108, "name": "Multilingual Guest Concierge Kiosk", "category": "INFO", "zone_id": 1, "accessibility_equipped": True, "distance_m": 85, "walking_time_mins": 1, "crowd_level_pct": 20, "status": "OPEN"},
    ])
...
def execute_fan_action():
    ...
    from models import StadiumZone
    zones = StadiumZone.query.all()
    least_congested = min(zones, key=lambda z: (z.current_occupancy / max(z.capacity, 1))) if zones else None
